...
export const ELISEO_POSES = ['idle', 'walk1', 'walk2', 'dash', 'jump', 'roll', 'aa', 'smash', 'tilt'];
...
// Same move keys as AndyFighter's controls (J/K/L/I/U + Shift roll),
// remapped to Eliseo's frame set and LoL flavor.
export const ELISEO_MOVES = {
  punch: {                       // J — quick aa jab
    label: 'Spectral jab',
    pose: 'aa', duration: 0.3, animRate: 0.09,
    active: [0.04, 0.2], reach: 46, heightRatio: 0.3,
    damage: 3, base: 140, scaling: 0.7, angle: -0.15,
  },
  windup: {                      // hold K — blade raised
    label: 'Ruined charge',
    pose: 'smash', duration: Infinity, animRate: 0.3,
  },
  golfswing: {                   // release K — the smash
    label: 'Ruined King smash',
    pose: 'smash', duration: 0.45, animRate: 0.2,
    active: [0.06, 0.2], reach: 72, heightRatio: 0.65,
    damage: 10, base: 260, scaling: 2.3, angle: -0.4,
  },
  serve: {                       // L — tilt (low angled poke, melee)
    label: 'Tilt poke',
  ...
  roll: {                        // Shift — roll
    label: 'Roll',
    pose: 'roll', duration: 0.34, animRate: 0.2,
  },
};
