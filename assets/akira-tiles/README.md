# The Akira City tileset

Integrated art pass: Neo-Tokyo cybercity tiles for vertical exploration. Sixteen transparent prop groups dress the three chambers, with a climbable rooftop route, neon-lit pipes and three optional memories to discover with E. All existing artwork is reused; integration required no new generation.

One built-in imagegen call produced tileset-v2.png, a 1254 × 1254 opaque source atlas with sixteen environmental modules. Exact prompt: generation-prompt.txt. Inspired by AKIRA: neon-drenched cybercity, vertical exploration, biomechanical infrastructure, and restricted Genesis-era palette.

| Row | 1 | 2 | 3 | 4 |
| --- | --- | --- | --- | --- |
| 1 | High-rise facade | Building corner | Stone platform | Platform with neon strip |
| 2 | Mechanical wall | Pipe segment | Fire escape | Ceiling with neon tubes |
| 3 | Neon-lit shop door | Open doorway | Dormant power core | Powered core (cyan) |
| 4 | Cyber wall | Neon transit arch | Data mural | Water with amber surface |
